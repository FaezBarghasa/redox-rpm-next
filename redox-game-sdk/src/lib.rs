//! # Redox Game SDK — System Abstraction Layer for Redox OS
//!
...
/// Standard Audio Parameters for Redox Game Streams
...
/// Redox OS Audio Client Stream Wrapper
pub struct RedoxAudioStream {
    file: File,
}

impl RedoxAudioStream {
...
pub fn enable_game_mode() -> Result<(), std::io::Error> {
    log::info!("Requesting Redox OS Exclusive Game Mode...");
